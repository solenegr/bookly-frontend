...
export default function ChatScreen({ navigation, route: { params } }) {
  const { conversationId, challengeId, users } = params;
  ...
  //   (() => {
  //     fetch(
  //       `http://${process.env.IP_ADDRESS}:3000/conversations/${params.conversationId}/add-user/${params.userId}`,
  //       { method: "PUT" }
  //     );
  //     // fetch(`${process.env.IP_ADDRESS}/conversations/users/${params.username}`, { method: 'PUT' });
  ...
  //     fetch(
  //       `http://${process.env.IP_ADDRESS}:3000/challenges/${params.challengeId}/messages`
  //     )
  ...
  //   return () =>
  //     fetch(
  //       `http://${process.env.IP_ADDRESS}:3000/conversations/${params.conversationId}/remove-user/${params.userId}`,
  //       { method: "DELETE" }
  //     );
  // }, [params.username]);
  ...
  //   console.log(params);
  //   fetch(
  //     `http://${process.env.IP_ADDRESS}:3000/messages/${params.userId}/conv/${params.conversationId}`,
  //     {
  //       method: "POST",
  ...
  //   // fetch(`${process.env.IP_ADDRESS}/messages/message`, {
  //   //   method: 'POST',
  //   //   headers: { 'Content-Type': 'application/json' },
      ...
      <View style={styles.inset}>
        ...
        <View style={styles.inputContainer}>
          ...
          <TouchableOpacity
            style={[
              styles.recordButton,
              recording && { backgroundColor: "rgba(248, 83, 83, 0.5)" },
            ]}
